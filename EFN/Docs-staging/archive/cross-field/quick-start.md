<!-- DEPRECATED: Content has been distributed across multiple consolidated guides -->
<!-- Archived: 2025-01-06 for disaster recovery only -->
<!-- DO NOT UPDATE: Content now in field-selection-guide.md, form-structure-guide.md, and implementation-patterns-guide.md -->
